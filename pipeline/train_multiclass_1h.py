...
# 1. Cargar datos
# =========================
DATA_PATH = Path(r"C:\Users\AGES\Documents\SALA\Hackaton_Sala\output\official\dataset_1h.csv")
...
out_path = DATA_PATH.parent / "results_1h_baselines.csv"
...
# =========================
# 9. Guardar submission oficial 1h
# =========================
...
submission = pd.DataFrame({
    ...
    "obs_class": test_df["obs_class_1h"].astype(int),
    "obs_precip_mm": test_df["obs_precip_1h"].astype(float),
})

submission_path = DATA_PATH.parent / "submission_1h.csv"
