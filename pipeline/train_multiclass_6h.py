...
# 1. Cargar datos
# =========================
DATA_PATH = Path(r"C:\Users\AGES\Documents\SALA\Hackaton_Sala\output\official\dataset_6h.csv")
...
out_path = DATA_PATH.parent / "results_6h_baselines.csv"
...
# =========================
# 9. Guardar submission oficial 6h
# =========================
...
submission = pd.DataFrame({
    ...
    "obs_class": test_df["obs_class_6h"].astype(int),
    "obs_precip_mm": test_df["obs_precip_6h"].astype(float),
})

submission_path = DATA_PATH.parent / "submission_6h.csv"
